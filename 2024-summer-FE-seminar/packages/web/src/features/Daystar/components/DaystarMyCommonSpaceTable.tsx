...
interface DaystarCommonSpaceTableProps {
  spaceList: ApiCms006ResponseOk | undefined; // 밖에서 실제 요청 데이터 넣어서 쓰기 위해 undefined 허용
}

const DaystarMyCommonSpaceTable: React.FC<DaystarCommonSpaceTableProps> = ({
  spaceList,
}) =>
  spaceList === undefined ? (
    <div>Error!</div>
...
export default DaystarMyCommonSpaceTable;
