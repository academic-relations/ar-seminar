...
interface DaystarAcfTableProps {
  certificateList: ApiAcf003ResponseOk | undefined;
}

const DaystarMyActivityCertificateTable: React.FC<DaystarAcfTableProps> = ({
  certificateList,
}) =>
...
export default DaystarMyActivityCertificateTable;
