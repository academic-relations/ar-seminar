...
interface RentalTableProps {
  rentalList: ApiRnt003ResponseOK | undefined; // 밖에서 실제 요청 데이터 넣어서 쓰기 위해 undefined 허용
}
const DaystarMyRentalTable: React.FC<RentalTableProps> = ({ rentalList }) =>
...
export default DaystarMyRentalTable;
